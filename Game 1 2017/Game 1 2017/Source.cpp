...
int main(int argc, char **argv) {
	...
	while (1 && health>0) {//while loop that keeps the game open as long as user's health is above 0
		...
		case 2:system("Color E0");
			...
			al_draw_bitmap(picture2, 0, 200, 0);
			al_flip_display();
		...
		case 3:system("Color FB");
			...
			al_draw_bitmap(picture3, 0, 50, 0);
			al_flip_display();
		...
		case 4:system("Color 4F");
			...
			al_draw_bitmap(picture4, -20, 50, 0);
			al_flip_display();
		...
		case 5: system("Color 20");
			...
			al_draw_bitmap(picture5, -20, 50, 0);
			al_flip_display();
		...
		case 6:system("Color 5F");
			...
			al_draw_bitmap(picture6, 0, 50, 0);
			al_flip_display();
		...
		case 7: system("Color 0F");
			...
			al_draw_bitmap(picture7, 0, 50, 0);
			al_flip_display();
